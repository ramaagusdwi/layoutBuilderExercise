...
class LandscapeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Padding(
        padding: EdgeInsets.only(top: statusBar + screenHeight * 0.03),
        child: Row(
  ...
  Container _header(BuildContext context) {
    return Container(
      //kolom 1
      width: context.media.size.width * 0.42,
      height: context.media.size.height * 0.60,
      margin: EdgeInsets.symmetric(horizontal: context.media.size.width * 0.05),
      padding:
          EdgeInsets.symmetric(horizontal: context.media.size.width * 0.01),
          ...
          Padding(
            ...
            child: Align(
              ...
              child: Icon(
                Icons.refresh,
                color: Colors.black,
                size: context.media.size.width * 0.03,
              ),
            ),
          )
        ],
  ...
  Container buildContainer1(
    ...
    return Container(
      width: screenWidth * 0.40,
      height: finalHeight * 0.30,
      padding: EdgeInsets.only(
          left: screenWidth * 0.03,
          top: finalHeight * 0.03,
